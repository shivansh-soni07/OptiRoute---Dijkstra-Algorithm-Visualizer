...
export default class PathfindingVisualizer extends Component {
  ...
  visualizeDijkstra() {
    this.setState({ topMessage: "Made with 💖 By Shivansh " });
  ...
  render() {
    ...
    if (topMessage === "Shortest Path") {
      button_task = (
        ...
        >
          Reset <br />
          Shortest Distance : {distanceToBeTraveled} Units
          
        </h2>
      );
    } else if (topMessage === "Made with 💖 By Shivansh ") {
      button_task = <h3 className="running">Running...</h3>;
    }

    let changeWeightText = "Use Weights";

    if (this.state.changeWeight) changeWeightText = "Use Walls";
    ...
    // if (topMessage === "Made with 💖 By Shivansh ") {
    //   textBox = null;
    ...
    return (
      <div className="pathfindingVisualizer">
        <div className="container">
          ...
          <p>
            Graphical Visualization of Dijkstra Algorithm {" "}
       ...
       { textBox = (
        <div
          className="buttonContainer"
          style={{ width: "50%", margin: "0 auto" , fontSize:"larger"}}
        >
          {button_task}
        </div>
      )}
